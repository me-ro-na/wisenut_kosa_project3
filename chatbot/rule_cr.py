...
ling_nowcode = pd.read_csv(rf'{os.path.abspath("project_name/chatbot/datasets/2020_code.csv")}')
ling_survey = pd.read_csv(rf'{os.path.abspath("project_name/chatbot/datasets/first_2020.csv")}')
